...
enum LauncherRouting {
    static func isReserved(_ text: String) -> Bool {
        ...
        return ["define", "translate", "translation", "translator", "caffeinate", "emoji", "wifi", "wi-fi", "bluetooth", "bt", "audio", "input", "output", "vol", "volume", "mute", "unmute", "acp", "settings", "reload", "volant", "notes", "agents", "herdr", "cal", "today", "snip", "ext", "note", "clip"].contains(first)
    }
}
