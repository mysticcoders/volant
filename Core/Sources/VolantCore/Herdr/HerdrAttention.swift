...
public struct HerdrAttention: Equatable {
    public let text: String
    public let truncated: Bool

    public static func preview(_ data: Data) throws -> Self {
    ...
    public static func matches(_ target: AgentSession, in sessions: [AgentSession]) -> Bool {
