...
(import "wasi_snapshot_preview1" "proc_exit" (func $exit (param i32))) (memory (export "memory") 1 1) (data (i32.const 128) "OK")
    ...
    (func (export "_start") (i32.store (i32.const 0) (i32.const 0)) (i32.store (i32.const 4) (i32.const 65536)) (drop (call $write (i32.const 1) (i32.const 0) (i32.const 1) (i32.const 8))) (i32.store (i32.const 0) (i32.const 128)) (i32.store (i32.const 4) (i32.const 2)) (drop (call $write (i32.const 1) (i32.const 0) (i32.const 1) (i32.const 8)))))
