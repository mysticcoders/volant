...
UI_PATTERNS = (
    ...
    "Shared/LauncherRouting.swift", "Shared/ACPTypes.swift", "Shared/HerdrAttention.swift", "Shared/AgentProtocol.swift", "Volant/SystemControl/SystemSettingsDestination.swift",
