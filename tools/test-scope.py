...
UI_PATTERNS = (
    ...
    "Volant/Search/AppIndex.swift", "Volant/Files/FileSearch.swift", "Volant/Notes/NotesStore.swift", "Volant/Clipboard/*", "Volant/Extensions/*", "Shared/ExtensionProtocol.swift", "VolantExtensionHost/*", "extensions/*", "Volant/Panel/*", "Volant/Usage/UsageStore.swift", "Volant/Shortcuts/*", "Shared/AppleShortcut.swift", "Volant/Emoji/*", "Volant/Translation/*", "Volant/Dictionary/*", "Volant/Settings/Shortcut*.swift", "Volant/Settings/GlobalShortcutRow.swift",
