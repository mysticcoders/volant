...
final class ServiceDelegate: NSObject, NSXPCListenerDelegate {
    func listener(_ listener: NSXPCListener, shouldAcceptNewConnection connection: NSXPCConnection) -> Bool {
        connection.exportedInterface = NSXPCInterface(with: VolantExtensionHostProtocol.self)
        connection.remoteObjectInterface = NSXPCInterface(with: VolantCapabilityClientProtocol.self)
